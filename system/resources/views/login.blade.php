                        ...
                        <form action="{{url('login')}}" method="post">
                            @csrf
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="email"  placeholder="Email" title="Please enter you email" required="" value="" name="email" id="email" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input class="au-input au-input--full" type="password" placeholder="**" title="Please enter you email" required="" value="" name="password" id="password" class="form-control">
                                </div>
