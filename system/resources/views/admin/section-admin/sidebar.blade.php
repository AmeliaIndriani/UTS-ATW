...
<div class="sidebar-menu sticky-sidebar-menu">
  ...
  <div class="logo-icon text-center">
    <a href="{{url('home')}}" title="logo"><img src="{{url('public')}}/assets_admin/images/logo.png" alt="logo-icon"> </a>
  </div>
  <!-- //logo end -->
  ...
  <div class="sidebar-menu-inner">
    ...
    <ul class="nav nav-pills nav-stacked custom-nav">
      <li class="active"><a href="{{url('home')}}"><i class="fa fa-tachometer"></i><span> Dashboard</span></a>
      </li>
